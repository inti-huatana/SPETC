...
treatment of extended sources. Expected performance and the known limits of
validity are summarized.
\end{abstract}

\tableofcontents

\input{sections/01_introduction}
\input{sections/01b_chain}
\input{sections/02_radiometry}
\input{sections/03_atmosphere}
\input{sections/04_sky}
\input{sections/05_psf}
\input{sections/06_photometry}
\input{sections/07_spectroscopy}
\input{sections/08_filters}
\input{sections/08_expectations}
\input{sections/09_worked_example}
