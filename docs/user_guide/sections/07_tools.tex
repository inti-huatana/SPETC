...
from. Restart the program and the new templates appear in the selector
(the catalogue loads automatically from the bundled \code{data/} folder;
the template box reports only the number of spectra loaded). Surface-brightness and arbitrary-flux files
